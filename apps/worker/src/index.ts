...
function usage(): string {
  return [
    ...
    '  --task-kind KIND    Limit this tick to review_reminder, watchlist_monitor, holding_review_draft, re_review_check, shariah_rescreen, or portfolio_valuation_refresh.',
    '  --help              Show this help.',
    '',
    'Environment:',
