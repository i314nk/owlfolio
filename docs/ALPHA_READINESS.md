...
8. Strategy certification: Buffett 4-Pillar is the default strategy direction; other strategies need policy gates, valuation rules, Shariah handling, and provider certification before being first-class.
