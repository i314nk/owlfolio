...
const pipeline: PipelineProjection = {
  stage_counts: [
    ...
    { key: 'deep_dive', label: 'Deep dive · 7 lanes', count: 2, health: 'warn' },
  ...
  runs: [
    { research_case_id: 'rc-msft', ticker: 'MSFT', version: 2, stage_label: 'Deep dive (2/7 lanes)', status: 'running', source_count: 8, started_at: '2026-06-08T00:00:06Z', updated_at: '2026-06-08T00:00:06Z' },
...
describe('PipelineObservatory', () => {
  it('renders KPIs, flow map, runs table and drill-down', () => {
    ...
    expect(html).toContain('Deep dive · 7 lanes')
