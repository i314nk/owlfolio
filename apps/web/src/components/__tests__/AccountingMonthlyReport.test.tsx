...
describe('AccountingMonthlyReport', () => {
  it('renders current period summary, snapshot history, holdings, and cash limitations', () => {
    ...
    expect(html).toContain('Draft accounting report')
    expect(html).toContain('NAV freshness: as of 2026-06-30')
    ...
    expect(html).toContain('Manual valuation event coverage')
    expect(html).toContain('Cash ledger events: not modeled yet')
