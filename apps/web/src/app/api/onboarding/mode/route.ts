...
const VALID_MODES: AppConfig['mode'][] = ['unconfigured', 'personal-local']
...
/**
 * Switch the active mode through the idempotent, non-destructive S1 `switchMode`.
 *
 * This is the providers-page guided-setup mode control — re-editable at any time, NOT a one-shot wizard
 * step. It deliberately delegates to `switchMode` (which no-ops on the same already-initialized mode and
