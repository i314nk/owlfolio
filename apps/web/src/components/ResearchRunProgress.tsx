...
export function ResearchRunProgress({
  ...
  return createElement(
    ...
    createElement(
      ...
      'The deep dive runs through a quick screen, the circle of competence, seven specialist lanes, synthesis, and a decision. This page updates as each stage completes.',
    ),
    createElement(
      'ol',
