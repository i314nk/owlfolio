    ...
    PanelSection({
      ...
      children: createElement(
        ...
        bullets([
          ...
          createElement('span', { key: 6 }, gold('The 13F page feeds this funnel'), ' — /discovery monitors a small set of concentrated value superinvestors\u2019 quarterly SEC filings: their latest portfolios, buys, and sells. Filings arrive up to 45 days late, cover long US equities only, and give no reasons — every figure is stamped with its report and filing dates, and a signal is an ', gold('idea to research, never a copy trade'), '.'),
        ]),
