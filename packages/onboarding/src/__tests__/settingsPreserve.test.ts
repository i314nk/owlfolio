...
import { updateAppearanceSettings, updateShariahSettings } from '../onboarding'
...
describe('settings updates preserve sibling settings', () => {
  ...
  it('updateAppearanceSettings keeps the shariah toggle', async () => {
  ...
  it('updateShariahSettings keeps the theme', async () => {
